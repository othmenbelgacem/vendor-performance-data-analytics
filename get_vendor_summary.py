...
vendor_sales_summary = pd.read_sql_query("""
    ...
    SELECT
        ...
        ss.TotalExciseTax,
        fs.FreightCost,
        -- Calculations for the additional columns in the schema
        (ss.TotalSalesDollars - ps.TotalPurchaseDollars) AS GrossProfit,
        ((ss.TotalSalesDollars - ps.TotalPurchaseDollars) / NULLIF(ss.TotalSalesDollars, 0)) AS ProfitMargin,
    ...
    logging.info("Vendor summary table created and populated successfully.")
